...
void UndoLastEdit(AppRuntime &runtime) {
    ...
    const bool ok = desktoper2D::UndoLastEdit(
        runtime.model,
...
void RedoLastEdit(AppRuntime &runtime) {
    ...
    const bool ok = desktoper2D::RedoLastEdit(
        runtime.model,
        &runtime.reminder_service,
        &runtime.reminder_upcoming,
        runtime.undo_stack,
...
bool SaveEditorProjectJsonToDisk(AppRuntime &runtime, const std::string &project_path, std::string *out_error) {
    ...
    JsonObject root;
    root.emplace("schema", JsonValue::makeString("desktoper2D.editor.project.v1"));
    ...
    JsonObject feature;
    feature.emplace("sceneClassifierEnabled", JsonValue::makeBool(runtime.feature_flags.scene_classifier_enabled));
    feature.emplace("ocrEnabled", JsonValue::makeBool(runtime.feature_flags.ocr_enabled));
    feature.emplace("faceEmotionEnabled", JsonValue::makeBool(runtime.feature_flags.face_emotion_enabled));
    feature.emplace("faceParamMappingEnabled", JsonValue::makeBool(runtime.feature_flags.face_param_mapping_enabled));
    feature.emplace("asrEnabled", JsonValue::makeBool(runtime.feature_flags.asr_enabled));
    feature.emplace("chatEnabled", JsonValue::makeBool(runtime.feature_flags.chat_enabled));
    feature.emplace("pluginEnabled", JsonValue::makeBool(runtime.feature_flags.plugin_enabled));
...
bool LoadEditorProjectJsonFromDisk(AppRuntime &runtime,
    ...
    if (schema != "desktoper2D.editor.project.v1") {
    ...
    if (const JsonValue *feature = root.get("feature"); feature && feature->isObject()) {
        runtime.feature_flags.scene_classifier_enabled = feature->getBool("sceneClassifierEnabled").value_or(runtime.feature_flags.scene_classifier_enabled);
        runtime.feature_flags.ocr_enabled = feature->getBool("ocrEnabled").value_or(runtime.feature_flags.ocr_enabled);
        runtime.feature_flags.face_emotion_enabled = feature->getBool("faceEmotionEnabled").value_or(runtime.feature_flags.face_emotion_enabled);
        runtime.feature_flags.face_param_mapping_enabled = feature->getBool("faceParamMappingEnabled").value_or(runtime.feature_flags.face_param_mapping_enabled);
        runtime.feature_flags.asr_enabled = feature->getBool("asrEnabled").value_or(runtime.feature_flags.asr_enabled);
        runtime.feature_flags.chat_enabled = feature->getBool("chatEnabled").value_or(runtime.feature_flags.chat_enabled);
        runtime.feature_flags.plugin_enabled = feature->getBool("pluginEnabled").value_or(runtime.feature_flags.plugin_enabled);
    }
